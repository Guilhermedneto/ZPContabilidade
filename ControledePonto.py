...
def load_funcionarios_data():
    df = pd.read_excel('funcionarios.xlsx', parse_dates=['data_admissao'],
...
if senha_correta or page != "Consultar ponto":
    ...
    if page == "Página Inicial":
        ...
        # Obtém a lista de usuários a partir dos dados de registro de ponto
        usuarios = df_registro_ponto['nome'].unique()
